...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """ Test retrieving recipes for current user only """
        user2 = get_user_model().objects.create_user(
            email="masikember@bszu.dev",
            password='testpass534'
        )
    ...
    def test_create_recipe_w_ingredients(self):
        ...
        ingredient3 = sample_ingredient(user=self.user, name='Curry')
        payload = {
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_upload_image_recipe_success(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".jpg") as ntf:
            ...
            ntf.seek(0)  # set file to start so it can be opened again
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Rec1')
        tag1 = sample_tag(user=self.user, name='Tag1')
        recipe1.tags.add(tag1)

        recipe2 = sample_recipe(user=self.user, title='Rec2')
        tag2 = sample_tag(user=self.user, name='Tag2')
        recipe2.tags.add(tag2)

        recipe3 = sample_recipe(user=self.user, title='Rec3')
